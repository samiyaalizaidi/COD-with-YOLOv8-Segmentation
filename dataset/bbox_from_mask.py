...
def generate_YOLO_bbox(input_directory: str, output_directory: str, GT_EXT='png'):
    """
    ...
    for filename in os.listdir(input_directory):
        ...
        for contour in contours:
            ...
            string_label += f'0 {normalized_x:.6f} {normalized_y:.6f} {normalized_width:.6f} {normalized_height:.6f}\n'
